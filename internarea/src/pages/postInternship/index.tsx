...
const index = () => {
  ...
  const handlesubmit = async (e: React.FormEvent) => {
    ...
    try {
      setisloading(true);
      const res = await axios.post(`${process.env.NEXT_PUBLIC_API_URL || "${process.env.NEXT_PUBLIC_API_URL || "https://internshala-clone-y2p2.onrender.com/api"}"}/internship`, formData);
